...
<urn:uuid:baf770fd-fe82-4467-be0b-9f158f38583e>
  <rdf:object> <nobel:FileType/instance>;
  <rdf:predicate> <nobel:fileType>;
  <rdf:subject> <nobel:AwardFile/instance> .
...
<urn:uuid:d1691dab-514c-40e4-9ba2-349763ba5b98>
  <rdf:object> <nobel:Category/instance>;
...
<urn:uuid:7f16aa90-1d8b-4e1d-9dee-0d276513c8db>
  ...
  <rdf:subject> <foaf:Person/instance> .
...
<urn:uuid:d987549b-018d-4090-ad68-c6d408eb8ac5>
  <rdf:object> <nobel:NobelPrize/instance>;
  <rdf:predicate> <nobel:nobelPrize>;
  <rdf:subject> <foaf:Person/instance> .

<urn:uuid:19950838-1ffd-4cf1-9a5a-172b05163b1a>
  <rdf:object> <onto:City/instance>;
...
<urn:uuid:7cbe90a2-bfd4-4bd0-8039-3ab93defac21>
  <rdf:object> <onto:Country/instance>;
  <rdf:predicate> <onto:birthPlace>;
  <rdf:subject> <foaf:Person/instance> .

<urn:uuid:efa45057-a97b-4556-affa-1c0abf30735f>
  <rdf:object> <onto:University/instance>;
...
<urn:uuid:24e8c211-60b1-45f4-b4e0-6ce5b9b4322f>
  ...
  <rdf:subject> <nobel:LaureateAward/instance> .
...
<urn:uuid:b13eb97f-8a82-45b6-a675-74ebe3b46b29>
  <rdf:object> <nobel:AwardFile/instance>;
...
<urn:uuid:268941d1-a51b-4032-9437-377b9e78dad1>
  <rdf:object> <rdf:Literal>;
  <rdf:predicate> <foaf:givenName>;
  <rdf:subject> <foaf:Organization/instance> .
...
<urn:uuid:3e2f8f70-132c-43e4-9ebb-3a797a2aef89>
  <rdf:object> <rdf:Literal>;
  <rdf:predicate> <skos:hiddenLabel>;
  <rdf:subject> <nobel:Category/instance> .

<urn:uuid:072cc1fe-d7a1-4128-9f98-206452ee3ede>
  <rdf:object> <rdf:Literal>;
  <rdf:predicate> <owl:sameAs>;
  <rdf:subject> <nobel:Category/instance> .

<urn:uuid:0b707518-d733-49df-b51c-7b77e141befe>
  <rdf:object> <rdf:Literal>;
  <rdf:predicate> <rdfs:label>;
  <rdf:subject> <nobel:Category/instance> .

<urn:uuid:862f5d48-5f40-4ce1-9069-3ea6379b5172>
  <rdf:object> <rdf:Literal>;
  <rdf:predicate> <skos:prefLabel>;
  <rdf:subject> <nobel:Category/instance> .

<urn:uuid:e37eb9df-3739-488d-ac8a-69b9b70dcb53>
  <rdf:object> <rdf:Literal>;
  <rdf:predicate> <rdfs:value>;
  <rdf:subject> <nobel:Category/instance> .

<urn:uuid:1ecefd86-e2dd-4bf8-927a-39b3201bffe7>
  <rdf:object> <rdf:Literal>;
...
<urn:uuid:8d0b4a7a-b103-44ce-a82c-cb19602c7938>
  <rdf:object> <rdf:Literal>;
  <rdf:predicate> <rdfs:label>;
  <rdf:subject> <nobel:FileType/instance> .

<urn:uuid:7d84b14b-e85b-44b3-95b1-a56e766ee04f>
  <rdf:object> <nobel:PrizeFile/instance>;
  <rdf:predicate> <nobel:prizeFile>;
  <rdf:subject> <onto:Award/instance> .
...
<urn:uuid:2e82d233-6657-4055-a70c-1741ecaba837>
  <rdf:object> <rdf:Literal>;
  <rdf:predicate> <rdfs:label>;
  <rdf:subject> <rdfs:Class/instance> .

<urn:uuid:e999257d-89b5-473a-8e0f-c14db7822eeb>
  <rdf:object> <nobel:Laureate/instance>;
  <rdf:predicate> <nobel:laureate>;
  <rdf:subject> <nobel:NobelPrize/instance> .
...
<urn:uuid:cfbf21e8-9474-419a-8b5f-b747235a3362>
  <rdf:object> <nobel:FileType/instance>;
  <rdf:predicate> <nobel:fileType>;
  <rdf:subject> <nobel:PrizeFile/instance> .
...
<urn:uuid:7ed5196d-5950-40f8-ae03-817be3696884>
  <rdf:object> <rdf:Literal>;
  <rdf:predicate> <owl:sameAs>;
  <rdf:subject> <onto:City/instance> .
...
<urn:uuid:4fe8b0d6-4419-49fe-b67d-91c8a80e4f83>
  ...
  <rdf:subject> <onto:University/instance> .
...
<urn:uuid:b9efe9ea-c8d5-44ac-90b0-449a32aacc76>
  <rdf:object> <foaf:Organization/instance>;
  <rdf:predicate> <nobel:laureate>;
  <rdf:subject> <nobel:LaureateAward/instance> .
...
<urn:uuid:daf87651-002a-4148-ac53-9ee72b5a57ae>
  <rdf:object> <onto:Award/instance>;
  <rdf:predicate> <nobel:laureateAward>;
  <rdf:subject> <nobel:Laureate/instance> .
...
<urn:uuid:dc0c95a8-dcfc-4387-afb6-95184fe292ff>
  <rdf:object> <rdf:Literal>;
  <rdf:predicate> <rdfs:label>;
  <rdf:subject> <onto:Country/instance> .
...
<nobel:AwardFile/instance> a <nobel:AwardFile> .
<nobel:FileType/instance> a <nobel:FileType> .
<nobel:Category/instance> a <nobel:Category> .
<foaf:Person/instance> a <foaf:Person> .
<nobel:LaureateAward/instance> a <nobel:LaureateAward> .
<onto:Award/instance> a <onto:Award> .
<nobel:NobelPrize/instance> a <nobel:NobelPrize> .
<onto:City/instance> a <onto:City> .
<onto:Country/instance> a <onto:Country> .
<onto:University/instance> a <onto:University> .
<nobel:Laureate/instance> a <nobel:Laureate> .
<foaf:Organization/instance> a <foaf:Organization> .
<nobel:PrizeFile/instance> a <nobel:PrizeFile> .
<rdfs:Class/instance> a <rdfs:Class> .
```
